...
public class FirmsDialogController implements Initializable {
    @FXML
    ...
    private void createTable(){
        ...
        try(PreparedStatement preparedStatement=conn.prepareStatement("select * from firm");
            ResultSet rs= preparedStatement.executeQuery();) {
            while (rs.next()) {
                System.out.println(rs.getInt(1)+rs.getString(2)+rs.getString(3));
                usersData.add(new Data(rs.getInt(1), rs.getString(2), rs.getString(3)));
            }
    ...
    public void delete(ActionEvent actionEvent) throws SQLException {
        PreparedStatement preparedStatement = conn.prepareStatement("DELETE FROM firm CASCADE WHERE id=?");
    ...
    private PreparedStatement preparedStatementSave() throws SQLException {
        PreparedStatement preparedStatement = conn.prepareStatement("INSERT INTO firm (name, address) VALUES (?,?)");
